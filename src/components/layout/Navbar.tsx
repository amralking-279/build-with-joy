...
import {
  ...
  Loader2, Download, Settings, Users
} from 'lucide-react';
...
const moreFeatures: MoreFeature[] = [
  ...
  { href: '/more/prophets-stories', label: 'قصص الأنبياء', icon: Users, available: true, color: 'purple' },
        ...
        {updateResult && (
          ...
          >
            <motion.div
              ...
              className="w-full max-w-sm rounded-2xl border border-emerald-800 bg-[#030a06] p-6 relative"
            >
              <button
                onClick={() => setUpdateResult(null)}
