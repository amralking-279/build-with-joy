          ...
          {nextPrayer && (
            ...
            >
              <div className="glass-card rounded-2xl p-6 border border-emerald-500/30 inline-block min-w-[280px]">
                ...
                <div className="flex items-center justify-center gap-1 text-4xl md:text-5xl font-mono text-emerald-300 prayer-countdown rounded-xl px-4 py-2">
                  <span className="prayer-countdown-cell bg-emerald-950/70 text-white rounded-lg px-3 py-1">{nextPrayer.countdown?.split(':')[0]}</span>
                  <span className="prayer-countdown-sep text-emerald-500 animate-pulse">:</span>
                  <span className="prayer-countdown-cell bg-emerald-950/70 text-white rounded-lg px-3 py-1">{nextPrayer.countdown?.split(':')[1]}</span>
                  <span className="prayer-countdown-sep text-emerald-500 animate-pulse">:</span>
                  <span className="prayer-countdown-cell bg-emerald-950/70 text-white rounded-lg px-3 py-1">{nextPrayer.countdown?.split(':')[2]}</span>
                </div>
